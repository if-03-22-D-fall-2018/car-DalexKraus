...
void set_acceleration_rate(Car car, double acceleration_rate)
{
    ...
    else car->car_data.acceleration_rate = car->car_data.highest_acceleration_rate;
}
...
void accelerate(Car car)
{
    ...
    {
        double delta = car->car_data.max_speed - car->car_data.speed;
        car->car_data.speed += delta;
    }
}
